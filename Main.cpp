//-----------------------------------------------------------------------------
// Lighting_Multiple.cpp by Steve Jones 
...
int main()
{
	...
	while (!glfwWindowShouldClose(gWindow))
	{
		...
		lightingShader.use();
		lightingShader.setUniform("model", glm::mat4());  // do not need to translate the models so just send the identity matrix
		...
		lightingShader.setUniform("sunLight.diffuse", glm::vec3(0.5f, 0.5f, 0.5f));		// dark
